...
#main-view.fill.col
	details
		summary Configure...
		git-input args="log --graph --oneline --pretty=VSCode --author-date-order -n 15000 --skip=0 --all $(git reflog show --format='%h' stash)" :options="[ { value: '--reflog', default_active: false } ]" config_key="main-log" hide_result="" :action="run_log" :immediate="true" ref="git_input_ref"
	.row.flex-1
		#log.col.flex-1
